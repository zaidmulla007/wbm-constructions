  ...
  return (
    <>
      ...
      <motion.div
        ...
        onClick={handleConsultationClick}
      >
        <div className="bg-gradient-to-b from-gold to-gold-dark text-dark py-4 px-2 shadow-lg rounded-l-lg">
      ...
      <div className="fixed bottom-4 right-2 sm:right-4 z-50 flex flex-col gap-3 sm:gap-4">
        ...
        <motion.a
          ...
          whileHover={{ scale: 1.1 }}
          whileTap={{ scale: 0.9 }}
          className="w-12 h-12 sm:w-14 sm:h-14 bg-gold hover:bg-gold-dark rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300"
